...
// Regexes that match native regex syntax
        nativeTokens = {
            ...
            // Any native multicharacter token in character cls scope (includes octals)
 ...
 *   <li>`scope` {String} Scopes where the token applies: 'default', 'cls', or 'all'.
...
/* Empty character cls: [] or [^]
 * Fixes a critical cross-browser syntax inconsistency. Unless this is standardized (per the spec),
 * regex syntax can't be accurately parsed because character cls endings can't be determined.
 */
    add(/\[(\^?)]/,
        function (match) {
...
// Expands a list of Unicode code points and ranges to be usable in a regex character cls
    function expand(str) {
...
(function (XRegExp) {
    ...
    XRegExp.addUnicodePackage({
        ...
        //Assigned: XRegExp("[\\p{^Cn}]").source.replace(/[[\]]|\\u/g, "") // Negation inside a character cls triggers inversion
